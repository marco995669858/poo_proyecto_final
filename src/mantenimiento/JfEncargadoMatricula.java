...
public class JfEncargadoMatricula extends JInternalFrame implements ActionListener, MouseListener {
	...
	private void registrarEncargadoMatricula() {
		...
		EncargadoMatricula nuevoEncargadoMatricula = new EncargadoMatricula(idEncargadoMatricula, txtCargo.getText(),
				txtDni.getText(), txtDireccion.getText(), txtApellido.getText(),
