...
public class JfEncargadoMatricula extends JInternalFrame implements ActionListener, MouseListener{
	...
	private void registrarEncargadoMatricula() {
		...
		if (resultado) {
			...
			JOptionPane.showMessageDialog(this, "Error al guardar el Encargado matricula", "Error", JOptionPane.WARNING_MESSAGE);
		}
	...
	void editarEncargadoMatricula() {
		...
		if (idEncargadoMatricula> 0) {
			...
			if (resultado) {
				...
				JOptionPane.showMessageDialog(this, "Error al editar el Encargado matricula", "Error", JOptionPane.WARNING_MESSAGE);
			}
		}
